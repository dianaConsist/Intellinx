...
@Entity(name = "TargetConsultarCuentas")
@DiscriminatorValue("TargetConsultarCuentas")
@DisplayName(name = "Target Consultar Cuentas")
@EntityType(EntityTypeDescriptor.APPLICATIVE)

public class TargetConsultarCuentas extends AlertTarget  {
